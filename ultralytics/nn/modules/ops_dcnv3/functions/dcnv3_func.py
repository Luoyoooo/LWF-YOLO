...
try:
    ...
    amp_custom_fwd = partial(custom_fwd, device_type="cuda")
    amp_custom_bwd = partial(custom_bwd, device_type="cuda")
except ImportError:
    from torch.cuda.amp import custom_bwd, custom_fwd

    amp_custom_fwd = custom_fwd
    amp_custom_bwd = custom_bwd
